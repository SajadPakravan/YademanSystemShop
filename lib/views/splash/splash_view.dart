            ...
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  AppText.bodyMedium(
                    'فروشگاه تخصصی انواع لپ‌تاپ، کامپیوتر، اسپیکر و لوازم جانبی دیجیتال در اصفهان',
        ...
        children: <Widget>[
          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                AppText.bodyMedium(title, color: AppColors.onBrand, fontWeight: FontWeight.w800, textDirection: TextDirection.rtl),
                SizedBox(height: r.space(3)),
                AppText.bodySmall(description, color: AppColors.onBrand.withValues(alpha: 0.80), height: 1.6, textDirection: TextDirection.rtl),
              ],
            ),
          ),
          if (showRetry) ...<Widget>[
            SizedBox(width: r.space(8)),
            AppButton(label: 'تلاش دوباره', labelColor: AppColors.onBrand, type: AppButtonType.text, expand: false, onPressed: onRetry),
          ],
        ],
      ),
    );
