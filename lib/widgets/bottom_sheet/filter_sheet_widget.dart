      ...
      return StatefulBuilder(
        builder: (context, setSheetState) {
          ...
          return _FilterSheetShell(
            title: 'مرتب‌سازی',
            contentHeight: math.min(context.responsive.height * 0.52, context.responsive.space(364)),
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  title: AppText.bodyMedium(option.title, fontWeight: checked ? FontWeight.w700 : FontWeight.w400),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  AppText.bodySmall('مبالغ بر حسب تومان هستند', color: context.appColors.textMuted),
                ],
              ),
            ),
          );
...
double _adaptiveContentHeight(BuildContext context, int itemCount, {double itemExtent = 55, double maxFactor = 0.60}) {
  final available = context.responsive.height * maxFactor;
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  IconButton(onPressed: () => Navigator.pop(context), icon: const Icon(Icons.close_rounded), color: colors.textSecondary),
                  const Spacer(),
                  AppText.titleMedium(title, fontWeight: FontWeight.w800),
                  const Spacer(),
